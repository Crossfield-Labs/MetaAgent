...
export const WINDOWS_SETUP_EN_US: WindowsSetupI18n = {
  ...
  step1Desc: "Export and share MetaAgent PC Agent ZIP to the target Windows device.",
  step1Button: "Export and Share ZIP",
  exporting: "Exporting...",
  shareTitle: "MetaAgent PC Agent",
  ...
  step2Desc:
    "On Windows, unzip the exported ZIP. In the extracted file list, find metaagent_pc_agent.bat and double-click it.",

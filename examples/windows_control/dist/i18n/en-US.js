...
exports.WINDOWS_SETUP_EN_US = {
    ...
    subtitle: "Use script-driven UI to verify agent connection, share installer package, and apply config.",
    ...
    step2Desc: "On Windows, unzip the exported ZIP. In the extracted file list, find metaagent_pc_agent.bat and double-click it.",
    step3Title: "Step 3: Finish Web Wizard and Paste Config Below",
    step3Desc: "Follow the auto-opened web setup wizard. On the final step, click Copy, then paste the copied config into the field below.",
    configLabel: "Paste Copied Config JSON",
    configPlaceholder: "{\"WINDOWS_AGENT_BASE_URL\":\"http://...\",\"WINDOWS_AGENT_TOKEN\":\"...\"}",
    envTip: "Paste the full config copied in the final web wizard step. Must include WINDOWS_AGENT_BASE_URL and WINDOWS_AGENT_TOKEN.",
    applyButton: "Paste and Apply",
    applying: "Applying...",
    recheckButton: "Check Connection Again",
    checking: "Checking...",
    successApply: "Config env saved, windows_control import/use attempted, now re-checking connection.",

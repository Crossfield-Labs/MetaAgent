...
const Web = (function () {
    ...
    async function persistPageContentIfTooLong(payload, sessionId) {
        ...
        return Object.assign(Object.assign({}, payload), { snapshot: '(saved_to_file)', snapshot_chars: content.length, snapshot_saved_to: filePath, metaagent_clean_on_exit_dir: OPERIT_CLEAN_ON_EXIT_DIR, hint: 'Content is large and saved to file. Use read_file_part or grep_code to inspect it.' });
    }

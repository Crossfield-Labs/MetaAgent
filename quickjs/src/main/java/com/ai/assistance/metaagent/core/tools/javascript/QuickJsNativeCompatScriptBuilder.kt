...
internal fun buildQuickJsCompatScript(): String =
    """
        (function() {
            ...
            var timerState = root.__metaagentTimerState;
            if (!timerState || typeof timerState !== 'object') {
                timerState = { nextId: 1, entries: {} };
                root.__metaagentTimerState = timerState;
            }
            ...
            root.__metaagentDispatchTimer = function(timerId) {
                var normalizedId = Number(timerId) || 0;
            ...
            root.__metaagentClearAllTimers = function() {

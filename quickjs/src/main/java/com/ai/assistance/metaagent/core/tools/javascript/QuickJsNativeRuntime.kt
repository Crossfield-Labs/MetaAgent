...
class QuickJsNativeRuntime private constructor(
    ...
    fun dispatchTimer(timerId: Int): EvalResult {
        return eval(
            script = "(function(){ return globalThis.__metaagentDispatchTimer($timerId); })()",
    ...
    fun clearAllTimers(): EvalResult {
        return eval(
            script = "(function(){ if (typeof globalThis.__metaagentClearAllTimers === 'function') { globalThis.__metaagentClearAllTimers(); } return null; })()",

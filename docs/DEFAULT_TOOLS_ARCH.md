...
- **文件**：`app/src/main/java/com/ai/assistance/metaagent/core/config/SystemToolPrompts.kt`
- **你要做的事**：
...
- **文件**：`app/src/main/java/com/ai/assistance/metaagent/core/tools/ToolRegistration.kt`
- **你要做的事**：
...
- **常见目录**：
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/standard/*`
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/debugger/*`
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/admin/*`
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/root/*`
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/accessbility/*`
  - `app/src/main/java/com/ai/assistance/metaagent/core/tools/defaultTool/ToolGetter.kt`（按权限级别选择具体实现）
- **你要做的事**：
...
- **文件**：`app/src/main/java/com/ai/assistance/metaagent/core/tools/javascript/JsTools.kt`
- **你要做的事**：

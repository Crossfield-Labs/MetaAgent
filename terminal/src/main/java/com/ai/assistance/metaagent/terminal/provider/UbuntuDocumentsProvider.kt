package com.ai.assistance.metaagent.terminal.provider
...
class UbuntuDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.ai.assistance.metaagent.documents.ubuntu"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "MetaAgent Ubuntu")
        row.add(DocumentsContract.Root.COLUMN_SUMMARY, "Access MetaAgent Ubuntu terminal files")

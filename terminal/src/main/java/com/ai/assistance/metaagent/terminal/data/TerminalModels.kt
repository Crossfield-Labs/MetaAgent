package com.ai.assistance.metaagent.terminal.data
...
data class TerminalSessionData(
    ...
    val terminalSession: com.ai.assistance.metaagent.terminal.TerminalSession? = null,
    val pty: com.ai.assistance.metaagent.terminal.Pty? = null, // PTY 对象，用于获取终端模式

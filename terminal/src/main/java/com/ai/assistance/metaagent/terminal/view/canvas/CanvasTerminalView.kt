package com.ai.assistance.metaagent.terminal.view.canvas
...
import android.view.accessibility.AccessibilityManager
 ...
 import com.ai.assistance.metaagent.terminal.view.domain.ansi.TerminalChar
 import java.io.File
...
class CanvasTerminalView @JvmOverloads constructor(
    ...
    // PTY 引用（用于窗口大小同步）
    private var pty: com.ai.assistance.metaagent.terminal.Pty? = null
     ...
     * 设置 PTY（用于窗口大小同步）
     */
    fun setPty(pty: com.ai.assistance.metaagent.terminal.Pty?) {
        this.pty = pty

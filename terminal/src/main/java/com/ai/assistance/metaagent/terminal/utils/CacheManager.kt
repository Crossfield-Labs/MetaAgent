...
class CacheManager(private val context: Context) {
    ...
    suspend fun unmountUbuntuMounts(
        terminalManager: com.ai.assistance.metaagent.terminal.TerminalManager? = null
    ...
    suspend fun clearCache(terminalManager: com.ai.assistance.metaagent.terminal.TerminalManager? = null) = withContext(Dispatchers.IO) {

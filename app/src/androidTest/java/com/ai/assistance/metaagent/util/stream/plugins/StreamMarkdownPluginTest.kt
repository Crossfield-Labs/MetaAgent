package com.ai.assistance.metaagent.util.stream.plugins

import androidx.test.ext.junit.runners.AndroidJUnit4
import com.ai.assistance.metaagent.util.stream.asCharStream
...
class StreamMarkdownPluginTest {
    ...
    private suspend fun collectGroups(
            stream: com.ai.assistance.metaagent.util.stream.Stream<Char>,
            plugin: StreamPlugin
    ): List<GroupInfo> {
        val groupList = mutableListOf<GroupInfo>()

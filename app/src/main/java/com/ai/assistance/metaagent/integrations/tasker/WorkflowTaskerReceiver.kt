package com.ai.assistance.metaagent.integrations.tasker
 ...
 * 
 * This receiver allows Tasker to trigger MetaAgent workflows via broadcasts.
 */
class WorkflowTaskerReceiver : BroadcastReceiver() {

    companion object {
        private const val TAG = "WorkflowTaskerReceiver"
        const val ACTION_TRIGGER_WORKFLOW = "com.ai.assistance.metaagent.TRIGGER_WORKFLOW"

...
import com.ai.assistance.metaagent.data.model.*
import com.ai.assistance.metaagent.data.model.InputProcessingState as EnhancedInputProcessingState
...
import com.ai.assistance.metaagent.ui.floating.ui.fullscreen.XmlTextProcessor
    ...
    fun sendUserMessage(
        ...
        coroutineScope.launch(Dispatchers.IO) {
            ...
            try {
                ...
                val currentRoleName = characterName ?: "MetaAgent"
                logMessageTiming(
                ...
                val (provider, modelName) = try {
                    service.getProviderAndModelForFunction(
                        functionType = com.ai.assistance.metaagent.data.model.FunctionType.CHAT,
                        chatModelConfigIdOverride = chatModelConfigIdOverride,
                        chatModelIndexOverride = chatModelIndexOverride
                    )
                } catch (e: Exception) {

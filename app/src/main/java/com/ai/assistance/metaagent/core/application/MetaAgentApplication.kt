package com.ai.assistance.metaagent.core.application
...
import com.ai.assistance.metaagent.api.chat.AIForegroundService
import com.ai.assistance.metaagent.plugins.PluginRegistry
...
import com.ai.assistance.metaagent.ui.features.chat.webview.workspace.editor.language.LanguageFactory
import com.ai.assistance.metaagent.util.GlobalExceptionHandler
...
import com.ai.assistance.metaagent.util.AppIconManager
import com.ai.assistance.metaagent.util.SkillRepoZipPoolManager
import com.ai.assistance.metaagent.util.SerializationSetup
...
/** Application class for MetaAgent */
class MetaAgentApplication : Application(), ImageLoaderFactory, WorkConfiguration.Provider {
    ...
    companion object {
        ...
        // 全局应用实例
        lateinit var instance: MetaAgentApplication
            private set
        ...
        private const val TAG = "MetaAgentApplication"
    }
    ...
    override fun onCreate() {
        ...
        ShowerEnvironment.shellRunner = MetaAgentShowerShellRunner
        ...
        applicationScope.launch(Dispatchers.Default) {
            ...
            val toolHandler = AIToolHandler.getInstance(this@MetaAgentApplication)
        ...
        applicationScope.launch {
            ...
            try {
                val bound = com.ai.assistance.metaagent.data.repository.UIHierarchyManager.bindToService(this@MetaAgentApplication)

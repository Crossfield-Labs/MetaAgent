package com.ai.assistance.metaagent.provider
...
class MemoryDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.ai.assistance.metaagent.documents.memory"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "MetaAgent Memory Library")
    ...
    private fun includeDocument(result: MatrixCursor, documentId: String) {
        when (val ref = parseDocumentId(documentId)) {
            is DocRef.Root -> {
                ...
                row.add(DocumentsContract.Document.COLUMN_DISPLAY_NAME, "MetaAgent Memory")
    ...
    private fun buildMemoryJson(memory: com.ai.assistance.metaagent.data.model.Memory): String {
        val obj = JSONObject()

package com.ai.assistance.metaagent.services
...
import com.ai.assistance.metaagent.data.model.SerializableColorScheme
import com.ai.assistance.metaagent.data.model.SerializableTypography
import com.ai.assistance.metaagent.data.model.toComposeColorScheme
import com.ai.assistance.metaagent.data.model.toComposeTypography
import com.ai.assistance.metaagent.data.model.PromptFunctionType
import com.ai.assistance.metaagent.services.floating.FloatingWindowCallback
import com.ai.assistance.metaagent.services.floating.FloatingWindowManager
import com.ai.assistance.metaagent.services.floating.FloatingWindowState
import com.ai.assistance.metaagent.services.floating.StatusIndicatorStyle
...
class FloatingChatService : Service(), FloatingWindowCallback {
    ...
    companion object {
        ...
        const val ACTION_FLOATING_CHAT_SERVICE_STARTED = "com.ai.assistance.metaagent.action.FLOATING_CHAT_SERVICE_STARTED"
        const val ACTION_FLOATING_CHAT_SERVICE_STOPPED = "com.ai.assistance.metaagent.action.FLOATING_CHAT_SERVICE_STOPPED"
            ...
            if (wakeLock == null) {
                ...
                wakeLock =
                        powerManager.newWakeLock(
                                ...
                                "MetaAgentApp:FloatingChatServiceWakeLock"
                        )

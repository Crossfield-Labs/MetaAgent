package com.ai.assistance.metaagent.ui.features.demo.viewmodel
...
import com.ai.assistance.metaagent.ui.features.demo.state.DemoStateManager
...
class ShizukuDemoViewModel(application: Application) : AndroidViewModel(application) {
    ...
    val uiState: StateFlow<com.ai.assistance.metaagent.ui.features.demo.state.DemoScreenState> =
    ...
    fun toggleMetaAgentTerminalWizard() {
        stateManager.toggleMetaAgentTerminalWizard()
    }

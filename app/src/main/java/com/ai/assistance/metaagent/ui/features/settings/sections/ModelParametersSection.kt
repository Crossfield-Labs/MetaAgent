package com.ai.assistance.metaagent.ui.features.settings.sections
...
import com.ai.assistance.metaagent.data.model.ParameterCategory
import com.ai.assistance.metaagent.data.model.ParameterValueType
import com.ai.assistance.metaagent.data.model.StandardModelParameters
...
fun ModelParametersSection(
        ...
        if (config.hasCustomParameters &&
            ...
            try {
                ...
                val customParamsList =
                    json.decodeFromString<List<com.ai.assistance.metaagent.data.model.CustomParameterData>>(
                        config.customParameters
                    )
    ...
    // 状态
    var parameterToEdit by remember { mutableStateOf<com.ai.assistance.metaagent.data.model.CustomParameterData?>(null) }
...
private fun convertCustomParameterDataToModelParameter(
    customParam: com.ai.assistance.metaagent.data.model.CustomParameterData
): ModelParameter<*> {
...
): com.ai.assistance.metaagent.data.model.CustomParameterData {
    return com.ai.assistance.metaagent.data.model.CustomParameterData(
        id = param.id,
        name = param.name,
...
private fun AddCustomParameterDialog(
    onDismiss: () -> Unit,
    onSave: (com.ai.assistance.metaagent.data.model.CustomParameterData) -> Unit,
    existingParam: com.ai.assistance.metaagent.data.model.CustomParameterData? = null
) {

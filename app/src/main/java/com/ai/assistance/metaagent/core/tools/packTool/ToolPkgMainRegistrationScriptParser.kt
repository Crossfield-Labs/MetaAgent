                ...
                jsEngine.executeToolPkgMainRegistrationFunction(
                    ...
                    params =
                        mapOf(
                            ...
                            "__metaagent_ui_package_name" to toolPkgId,
                            "__metaagent_plugin_id" to "registerToolPkg:$toolPkgId",
                            "__metaagent_registration_mode" to true,
                            "__metaagent_script_screen" to mainScriptPath
                        )
                )

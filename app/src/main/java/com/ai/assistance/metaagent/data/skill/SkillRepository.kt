package com.ai.assistance.metaagent.data.skill
...
import com.ai.assistance.metaagent.core.tools.skill.SkillPackage
                    ...
                    if (!newDirName.isNullOrBlank()) {
                        try {
                            File(skillsRootDir, newDirName)
                                .resolve(".metaagent_repo_url")
                                .writeText(repoUrl.trim())
                        } catch (e: Exception) {
                            AppLogger.e(TAG, "Failed to write .metaagent_repo_url marker", e)
                        }
                    }
                }

...
class WebViewHandler(private val context: Context) {
    ...
    fun configureWebView(webView: WebView, mode: WebViewMode, tabId: String): WebView {
        return webView.apply {
            ...
            settings.apply {
                ...
                userAgentString = "Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/120.0.0.0 Safari/537.36 Edg/120.0.0.0 MetaAgentWebView/1.0"
            }
    ...
    private fun injectWorkspaceCorsProxyHelper(webView: WebView) {
        val js =
            """
        (function() {
            if (window.__metaagentCorsProxyInjected) { return; }
            window.__metaagentCorsProxyInjected = true;

package com.ai.assistance.metaagent.ui.features.workflow.screens
...
import com.ai.assistance.metaagent.ui.features.workflow.viewmodel.WorkflowViewModel
import com.ai.assistance.metaagent.ui.features.workflow.components.GridWorkflowCanvas
import com.ai.assistance.metaagent.ui.features.workflow.components.ConnectionMenuDialog
import com.ai.assistance.metaagent.ui.features.workflow.components.NodeActionMenuDialog
import com.ai.assistance.metaagent.ui.features.workflow.components.ScheduleConfigDialog
...
fun NodeDialog(
    ...
    val initialActionConfigPairs = if (node is ExecuteNode) {
        node.actionConfig.map { (key, paramValue) ->
            when (paramValue) {
                is com.ai.assistance.metaagent.data.model.ParameterValue.StaticValue -> 
                    ParameterConfig(key, false, paramValue.value)
                is com.ai.assistance.metaagent.data.model.ParameterValue.NodeReference -> 

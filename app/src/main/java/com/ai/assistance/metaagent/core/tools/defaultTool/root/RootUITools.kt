package com.ai.assistance.metaagent.core.tools.defaultTool.root
...
import com.ai.assistance.metaagent.core.tools.defaultTool.admin.AdminUITools
    ...
    override suspend fun setInputText(tool: AITool): ToolResult {
        ...
        try {
            ...
            withContext(Dispatchers.Main) {
                ...
                clipboard.setPrimaryClip(ClipData.newPlainText("metaagent_input", text))
            }
            delay(100)

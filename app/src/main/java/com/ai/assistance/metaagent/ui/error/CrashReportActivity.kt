package com.ai.assistance.metaagent.ui.error
...
class CrashReportActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent { MetaAgentTheme { CrashReportScreen(stackTrace = stackTrace) } }
    }
}
...
private fun exportToFile(context: Context, text: String) {
    try {
        ...
        val errorDir = File(downloadsDir, "MetaAgent/error")
        if (!errorDir.exists()) {
            errorDir.mkdirs()
        }

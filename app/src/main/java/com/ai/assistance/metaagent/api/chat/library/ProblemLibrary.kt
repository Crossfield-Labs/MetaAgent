package com.ai.assistance.metaagent.api.chat.library
...
object ProblemLibrary {
    ...
    private fun buildPreferencesText(context: Context, profile: com.ai.assistance.metaagent.data.model.PreferenceProfile): String {

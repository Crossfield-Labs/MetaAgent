package com.ai.assistance.metaagent.api.chat.enhance
...
import com.ai.assistance.metaagent.data.preferences.WaifuPreferences
...
import com.ai.assistance.metaagent.util.streamnative.NativeXmlSplitter
...
import com.ai.assistance.metaagent.core.tools.ComputerDesktopActionResultData
...
import com.ai.assistance.metaagent.api.chat.llmprovider.MediaLinkBuilder
    ...
    private suspend fun buildWaifuRulesText(): String {
        ...
        if (waifuEnableEmoticons) {
            ...
            val availableCategories = try {
                ...
                com.ai.assistance.metaagent.util.AppLogger.e("ConversationService", "获取表情分组失败", e)
                emptyList()
            }
...
${FunctionalPrompts.translationUserPrompt(targetLanguage, text)}
    ...
    suspend fun analyzeImageWithIntent(
        ...
        return try {
            ...
            // 添加图片到池子并获取ID
            val imageId = com.ai.assistance.metaagent.util.ImagePoolManager.addImage(imagePath)
            if (imageId == "error") {
            ...
            // 清理图片缓存
            com.ai.assistance.metaagent.util.ImagePoolManager.removeImage(imageId)
    ...
    suspend fun analyzeAudioWithIntent(
        ...
        return try {
            ...
            val mediaId = com.ai.assistance.metaagent.util.MediaPoolManager.addMedia(audioPath, mimeType)
            if (mediaId == "error") {
            ...
            com.ai.assistance.metaagent.util.MediaPoolManager.removeMedia(mediaId)
            result.toString()
        } catch (e: Exception) {
    ...
    suspend fun analyzeVideoWithIntent(
        ...
        return try {
            ...
            val mediaId = com.ai.assistance.metaagent.util.MediaPoolManager.addMedia(videoPath, mimeType)
            if (mediaId == "error") {

...
import com.ai.assistance.metaagent.api.speech.PersonalWakeListener
import com.ai.assistance.metaagent.api.speech.SpeechPrerollStore
import com.ai.assistance.metaagent.api.speech.SpeechService
...
import com.ai.assistance.metaagent.services.UIDebuggerService
...
import com.ai.assistance.metaagent.data.repository.WorkflowRepository
...
class AIForegroundService : Service() {
    ...
    companion object {
        ...
        private const val ACTION_CANCEL_CURRENT_OPERATION = "com.ai.assistance.metaagent.action.CANCEL_CURRENT_OPERATION"
        private const val REQUEST_CODE_CANCEL_CURRENT_OPERATION = 9002

        private const val ACTION_EXIT_APP = "com.ai.assistance.metaagent.action.EXIT_APP"
        private const val REQUEST_CODE_EXIT_APP = 9003

        private const val ACTION_TOGGLE_WAKE_LISTENING = "com.ai.assistance.metaagent.action.TOGGLE_WAKE_LISTENING"
        private const val REQUEST_CODE_TOGGLE_WAKE_LISTENING = 9006

        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_IME =
            "com.ai.assistance.metaagent.action.SET_WAKE_LISTENING_SUSPENDED_FOR_IME"
        ...
        private const val ACTION_SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN =
            "com.ai.assistance.metaagent.action.SET_WAKE_LISTENING_SUSPENDED_FOR_FLOATING_FULLSCREEN"
        private const val EXTRA_FLOATING_FULLSCREEN_ACTIVE = "extra_floating_fullscreen_active"

        const val ACTION_PREPARE_WAKE_HANDOFF =
            "com.ai.assistance.metaagent.action.PREPARE_WAKE_HANDOFF"

        private const val ACTION_ENSURE_MICROPHONE_FOREGROUND =
            "com.ai.assistance.metaagent.action.ENSURE_MICROPHONE_FOREGROUND"
    ...
    private fun createNotificationChannel() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            val channelName = getString(R.string.service_metaagent_running)
    ...
    private fun triggerWakeLaunch() {
        ...
        try {
            val floatingIntent = Intent(this, FloatingChatService::class.java).apply {
                putExtra("INITIAL_MODE", com.ai.assistance.metaagent.ui.floating.FloatingMode.FULLSCREEN.name)
    ...
    private fun createNotification(): Notification {
        ...
        val title =
            if (isAiBusy) {
                characterName ?: getString(R.string.service_metaagent_running)
            } else {
                if (wakeListeningEnabledSnapshot) {
                    ...
                    getString(R.string.service_metaagent_running)
                }
            }
        val builder = NotificationCompat.Builder(this, CHANNEL_ID)
            .setContentTitle(title)
            .setContentText(getString(R.string.service_metaagent_running))

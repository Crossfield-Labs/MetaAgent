 ...
 * 路径: /data/data/com.ai.assistance.metaagent/files/workspace
 */
class WorkspaceDocumentsProvider : DocumentsProvider() {
    ...
    companion object {
        ...
        private const val AUTHORITY = "com.ai.assistance.metaagent.documents.workspace"
    ...
    override fun queryRoots(projection: Array<out String>?): Cursor {
        ...
        row.add(DocumentsContract.Root.COLUMN_TITLE, "MetaAgent Workspace")

...
data class TavernExtensions(
    ...
    val metaagent: MetaAgentTavernExtension? = null
)

data class MetaAgentTavernExtension(
    val schema: String = "metaagent_character_card_v1",
    val character_card: MetaAgentCharacterCardPayload
)

data class MetaAgentCharacterCardPayload(
    val name: String = "",
    val description: String = "",
    ...
    val attachedTags: List<MetaAgentAttachedTagPayload> = emptyList(),
...
data class MetaAgentAttachedTagPayload(
    val id: String = "",
    val name: String = "",
    val description: String = "",

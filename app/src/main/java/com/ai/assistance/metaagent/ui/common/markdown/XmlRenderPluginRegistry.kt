...
import com.ai.assistance.metaagent.ui.common.composedsl.RenderToolPkgComposeDslNode
    ...
    private fun RenderComposeDslScreen(
        ...
        fun buildActionRuntimeOptions(screenPath: String): Map<String, Any?> =
            mapOf(
                ...
                "toolPkgId" to result.containerPackageName,
                "__metaagent_ui_package_name" to result.containerPackageName,
                "__metaagent_ui_toolpkg_id" to result.containerPackageName,
                "uiModuleId" to "xml_render",
                "__metaagent_ui_module_id" to "xml_render",
                "__metaagent_script_screen" to screenPath,

...
import com.ai.assistance.metaagent.api.chat.llmprovider.EndpointCompleter
import com.ai.assistance.metaagent.util.AppLogger
import com.ai.assistance.metaagent.util.ChatMarkupRegex
import com.ai.assistance.metaagent.util.ChatUtils
import com.ai.assistance.metaagent.util.LocaleUtils
import com.ai.assistance.metaagent.util.StreamingJsonXmlConverter
import com.ai.assistance.metaagent.util.TokenCacheManager
import com.ai.assistance.metaagent.util.exceptions.UserCancellationException
import com.ai.assistance.metaagent.util.stream.SharedStream
...
open class OpenAIProvider(
    ...
    private fun getOutputImagesDir(): File {
        ...
        return File(downloadsDir, "MetaAgent/output images")
    }
        ...
        for (param in modelParameters) {
            if (param.isEnabled) {
                ...
                when (param.valueType) {
                    com.ai.assistance.metaagent.data.model.ParameterValueType.INT ->
                        jsonObject.put(mappedApiName, param.currentValue as Int)

                    com.ai.assistance.metaagent.data.model.ParameterValueType.FLOAT ->
                        jsonObject.put(mappedApiName, param.currentValue as Float)

                    com.ai.assistance.metaagent.data.model.ParameterValueType.STRING ->
                        jsonObject.put(mappedApiName, param.currentValue as String)

                    com.ai.assistance.metaagent.data.model.ParameterValueType.BOOLEAN ->
                        jsonObject.put(mappedApiName, param.currentValue as Boolean)

                    com.ai.assistance.metaagent.data.model.ParameterValueType.OBJECT -> {
     ...
     * 从结构化参数构建JSON Schema
     */
    private fun buildSchemaFromStructured(params: List<com.ai.assistance.metaagent.data.model.ToolParameterSchema>): JSONObject {

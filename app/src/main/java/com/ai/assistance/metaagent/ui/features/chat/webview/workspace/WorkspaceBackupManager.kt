...
import com.ai.assistance.metaagent.core.tools.AIToolHook
...
import com.ai.assistance.metaagent.ui.features.chat.webview.workspace.process.GitIgnoreFilter
...
class WorkspaceBackupManager(private val context: Context) {
    ...
    private suspend fun loadGitignoreRulesProvider(workspacePath: String, workspaceEnv: String?): List<String> {
        ...
        rules.addAll(listOf(".backup", ".metaagent"))

...
import com.ai.assistance.metaagent.data.model.CustomParameterData
...
import com.ai.assistance.metaagent.data.model.ApiKeyInfo
...
class ModelConfigManager(private val context: Context) {
    ...
    suspend fun updateModelConfig(
            ...
            apiEndpoint: String,
            modelName: String,
            apiProviderType: com.ai.assistance.metaagent.data.model.ApiProviderType
    ): ModelConfigData {
        return updateConfigInternal(configId) {
            it.copy(
                    apiKey = apiKey,
...
private fun ModelParameter<*>.toCustomParameterData(): com.ai.assistance.metaagent.data.model.CustomParameterData {

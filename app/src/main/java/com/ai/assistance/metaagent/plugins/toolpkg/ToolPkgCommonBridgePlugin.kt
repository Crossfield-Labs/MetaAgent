package com.ai.assistance.metaagent.plugins.toolpkg

import android.content.Context
import androidx.compose.ui.graphics.Color
import com.ai.assistance.metaagent.R
import com.ai.assistance.metaagent.core.application.MetaAgentApplication
import com.ai.assistance.metaagent.core.chat.logMessageTiming
import com.ai.assistance.metaagent.core.chat.messageTimingNow
import com.ai.assistance.metaagent.core.chat.plugins.MessageProcessingController
import com.ai.assistance.metaagent.core.chat.plugins.MessageProcessingExecution
import com.ai.assistance.metaagent.core.chat.plugins.MessageProcessingHookParams
import com.ai.assistance.metaagent.core.chat.plugins.MessageProcessingPlugin
import com.ai.assistance.metaagent.core.chat.plugins.MessageProcessingPluginRegistry
...
import com.ai.assistance.metaagent.core.tools.packTool.TOOLPKG_EVENT_INPUT_MENU_TOGGLE
import com.ai.assistance.metaagent.core.tools.packTool.TOOLPKG_EVENT_MESSAGE_PROCESSING
import com.ai.assistance.metaagent.core.tools.packTool.TOOLPKG_EVENT_XML_RENDER
import com.ai.assistance.metaagent.plugins.MetaAgentPlugin
import com.ai.assistance.metaagent.ui.common.markdown.XmlRenderPlugin
import com.ai.assistance.metaagent.ui.common.markdown.XmlRenderPluginRegistry
import com.ai.assistance.metaagent.ui.common.markdown.XmlRenderResult
import com.ai.assistance.metaagent.ui.features.chat.components.style.input.common.InputMenuToggleDefinition
import com.ai.assistance.metaagent.ui.features.chat.components.style.input.common.InputMenuToggleHookParams
import com.ai.assistance.metaagent.ui.features.chat.components.style.input.common.InputMenuTogglePlugin
import com.ai.assistance.metaagent.ui.features.chat.components.style.input.common.InputMenuTogglePluginRegistry
import com.ai.assistance.metaagent.util.AppLogger
import com.ai.assistance.metaagent.util.stream.Stream
import com.ai.assistance.metaagent.core.tools.packTool.ToolPkgXmlRenderHookComposeDslResult
import com.ai.assistance.metaagent.core.tools.packTool.ToolPkgXmlRenderHookObjectResult
import com.ai.assistance.metaagent.util.stream.stream
...
private object ToolPkgXmlRenderBridgePlugin : XmlRenderPlugin {
    ...
    override fun supports(tagName: String): Boolean {
        ...
        return runCatching {
            val hooks = packageManager(MetaAgentApplication.instance).getToolPkgXmlRenderPlugins(normalizedTagName)
            hooks.isNotEmpty()
        }.onFailure { error ->
            AppLogger.e(
                TOOLPKG_LOG_TAG,
...
object ToolPkgCommonBridgePlugin : MetaAgentPlugin {

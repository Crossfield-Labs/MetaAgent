...
import com.ai.assistance.metaagent.core.tools.AppOperationData
import com.ai.assistance.metaagent.core.tools.LocationData
import com.ai.assistance.metaagent.core.tools.NotificationData
import com.ai.assistance.metaagent.core.tools.StringResultData
import com.ai.assistance.metaagent.core.tools.SystemSettingData
...
import java.io.File
import com.ai.assistance.metaagent.services.notification.MetaAgentNotificationStore
...
open class StandardSystemOperationTools(private val context: Context) {
    ...
    private fun isMetaAgentInternalPath(path: String): Boolean {
    ...
    private fun stageApkForInstallIfNeeded(apkFile: File): File {
        ...
        if (!isMetaAgentInternalPath(apkPath)) {
            return apkFile
        }

        val cleanOnExitDir = MetaAgentPaths.cleanOnExitDir()
    ...
    open suspend fun getNotifications(tool: AITool): ToolResult {
        ...
        return try {
            val notifications = MetaAgentNotificationStore.snapshot(
                limit = limit,

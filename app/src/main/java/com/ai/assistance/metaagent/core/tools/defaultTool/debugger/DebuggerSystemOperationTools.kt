...
import com.ai.assistance.metaagent.core.tools.defaultTool.accessbility.AccessibilitySystemOperationTools
...
open class DebuggerSystemOperationTools(context: Context) :
    ...
    override suspend fun installApp(tool: AITool): ToolResult {
        ...
        if (DebuggerFileSystemTools.isMetaAgentInternalPath(apkPath)) {
            AppLogger.d(
                TAG,
                "installApp detected MetaAgent internal path, delegating to AccessibilitySystemOperationTools"
            )

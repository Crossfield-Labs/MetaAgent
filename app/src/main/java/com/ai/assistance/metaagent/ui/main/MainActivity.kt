package com.ai.assistance.metaagent.ui.main
...
import com.ai.assistance.metaagent.data.migration.ChatHistoryMigrationManager
import com.ai.assistance.metaagent.data.preferences.AgreementPreferences
...
import com.ai.assistance.metaagent.data.updates.UpdateManager
import com.ai.assistance.metaagent.data.updates.UpdateStatus
import com.ai.assistance.metaagent.ui.common.NavItem
import com.ai.assistance.metaagent.ui.features.agreement.screens.AgreementScreen
import com.ai.assistance.metaagent.ui.features.migration.screens.MigrationScreen
import com.ai.assistance.metaagent.ui.features.permission.screens.PermissionGuideScreen
import com.ai.assistance.metaagent.ui.features.startup.screens.PluginLoadingScreenWithState
import com.ai.assistance.metaagent.ui.features.startup.screens.PluginLoadingState
...
import com.ai.assistance.metaagent.ui.theme.MetaAgentTheme
import com.ai.assistance.metaagent.ui.common.displays.VirtualDisplayOverlay
import com.ai.assistance.metaagent.util.AnrMonitor
...
class MainActivity : ComponentActivity() {
    companion object {
        const val ACTION_OPEN_SETTINGS_SHORTCUT = "com.ai.assistance.metaagent.action.OPEN_SETTINGS_SHORTCUT"
    }
    ...
    override fun onNewIntent(intent: Intent?) {
        ...
        val isGitHubOAuthCallback = intent?.data?.let { uri ->
            uri.scheme == "metaagent" && uri.host == "github-oauth-callback"
        } == true
    ...
    private fun handleIntent(intent: Intent?): Boolean {
        ...
        val uri = intent?.data
        if (uri != null && uri.scheme == "metaagent" && uri.host == "github-oauth-callback") {
    ...
    private fun cleanTemporaryFiles() {
        lifecycleScope.launch {
            try {
                ...
                cleanDirectory(java.io.File(MetaAgentPaths.cleanOnExitPathSdcard()), preserveRootNoMedia = true)
                cleanDirectory(MetaAgentPaths.cleanOnExitInternalDir(this@MainActivity), preserveRootNoMedia = false)
            } catch (e: Exception) {

...
object MetaAgentPaths {

    private const val OPERIT_DIR_NAME = "MetaAgent"
    ...
    fun cleanOnExitDir(): File {
        return ensureDir(File(metaagentRootDir(), CLEAN_ON_EXIT_DIR_NAME))
    }
    ...
    fun mcpPluginsDir(): File {
        return ensureDir(File(metaagentRootDir(), MCP_PLUGINS_DIR_NAME))
    }

    fun bridgeDir(): File {
        return ensureDir(File(metaagentRootDir(), BRIDGE_DIR_NAME))
    }

    fun exportsDir(): File {
        return ensureDir(File(metaagentRootDir(), EXPORTS_DIR_NAME))
    }

    fun workspaceDir(): File {
        return ensureDir(File(metaagentRootDir(), WORKSPACE_DIR_NAME))
    }

    fun testDir(): File {
        return ensureDir(File(metaagentRootDir(), TEST_DIR_NAME))
    }
    ...
    fun metaagentRootPathSdcard(): String {
        return "/sdcard/Download/$OPERIT_DIR_NAME"
    }

    fun cleanOnExitPathSdcard(): String {
        return "${metaagentRootPathSdcard()}/$CLEAN_ON_EXIT_DIR_NAME"
    }

    fun bridgePathSdcard(): String {
        return "${metaagentRootPathSdcard()}/$BRIDGE_DIR_NAME"
    }

    fun exportsPathSdcard(): String {
        return "${metaagentRootPathSdcard()}/$EXPORTS_DIR_NAME"
    }

    fun workspacePathSdcard(chatId: String): String {
        return "${metaagentRootPathSdcard()}/$WORKSPACE_DIR_NAME/$chatId"
    }

    fun testPathSdcard(): String {
        return "${metaagentRootPathSdcard()}/$TEST_DIR_NAME"
    }

...
import com.ai.assistance.metaagent.data.preferences.UserPreferencesManager.Companion.ON_COLOR_MODE_AUTO
import com.ai.assistance.metaagent.data.preferences.UserPreferencesManager.Companion.ON_COLOR_MODE_DARK
import com.ai.assistance.metaagent.data.preferences.UserPreferencesManager.Companion.ON_COLOR_MODE_LIGHT
...
@Composable
fun MetaAgentTheme(content: @Composable () -> Unit) {
    ...
    DisposableEffect(key1 = Unit) { 
        onDispose { 
            try {
                ...
                AppLogger.e("MetaAgentTheme", "ExoPlayer释放错误", e)
            }
        } 
    }

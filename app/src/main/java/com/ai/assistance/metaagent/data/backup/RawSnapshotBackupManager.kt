...
object RawSnapshotBackupManager {
    ...
    private const val ZIP_PREFIX = "metaagent_raw_snapshot_"
    ...
    suspend fun exportToBackupDir(
        ...
        mutex.withLock {
            ...
            val exportDir = MetaAgentBackupDirs.rawSnapshotDir()
            ...
            ZipOutputStream(BufferedOutputStream(FileOutputStream(tmpFile))).use { zos ->
                ...
                val alwaysExcluded = MetaAgentPaths.rawSnapshotExcludedFilesTopLevelDirNames()

...
METADATA
{
    ...
    "tools": [
        ...
        },
        {
            ...
            "description": { "zh": "通过微信发送文本消息，调起微信分享界面，由用户选择联系人并确认发送。仅适用于手动选择联系人，不适用于向指定联系人或群聊全自动发送消息；如果用户明确指定对象，必须改用 UI 自动化子代理。", "en": "Send a text message via WeChat by opening the share UI; the user selects the contact and confirms sending. This is only for manual contact selection, not for fully automatic sending to a specified contact or group. If the user specifies a target, you must use the UI automation sub-agent instead." },
            "parameters": [
                {
                    "name": "message",
        ...
        },
        {
            ...
            "description": { "zh": "通过QQ发送文本消息，调起QQ分享界面，由用户选择联系人并确认发送。仅适用于手动选择联系人，不适用于向指定联系人或群聊全自动发送消息；如果用户明确指定对象，必须改用 UI 自动化子代理。", "en": "Send a text message via QQ by opening the share UI; the user selects the contact and confirms sending. This is only for manual contact selection, not for fully automatic sending to a specified contact or group. If the user specifies a target, you must use the UI automation sub-agent instead." },
            "parameters": [
                {
                    "name": "message",
                    "description": { "zh": "要发送的文本内容", "en": "Text content to send." },

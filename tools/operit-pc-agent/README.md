# MetaAgent PC Agent (Windows)

Windows side helper project for MetaAgent.

- Local config UI: `http://127.0.0.1:58321`
- Single-entry launcher: `metaagent_pc_agent.bat`
...
2. Double click `metaagent_pc_agent.bat`.
...
- `metaagent_pc_agent.bat`: only user-facing launcher bat
...
- If browser does not open:
  ...
  4. Double click `metaagent_pc_agent.bat` again (it auto-cleans old process).
